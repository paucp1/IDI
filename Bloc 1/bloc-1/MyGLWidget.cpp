...
void MyGLWidget::creaBuffers ()
{
  ...
  glm::vec3 Vertices_1[3];  // Tres vèrtexs amb X, Y i Z
  Vertices_1[0] = glm::vec3(0.5, 1, 0.0);
  Vertices_1[1] = glm::vec3(1.0, 0.0, 0.0);
  Vertices_1[2] = glm::vec3(0.0, 0.0, 0.0);
